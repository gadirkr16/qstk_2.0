...
def find_events(ls_symbols, d_data, nbr):
...
if __name__ == '__main__':
    ...
    for df_number in ls_numbers_list:    
        df_events = find_events(ls_symbols, 
                                d_data, 
                                df_number)
        print "Creating Study"
        file_name = fl_name+str(df_number)+fl_type
